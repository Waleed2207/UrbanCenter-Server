...
exports.createReport = {
    async CreateReport(req, res) {
      try {
        const { user_id, category, description, location_lat, location_long, priority } = req.body;
    ...
    async updateReport(req, res) {
        try {
          const { id } = req.params;
          const { user_id, category, description, location_lat, location_long, priority, status } = req.body;
          ...
          const isUpdated =
            imageUpdated ||
            (user_id && user_id !== report.user_id.toString()) ||
            (category && category !== report.category) ||
            (description && description !== report.description) ||
            (location_lat && parseFloat(location_lat) !== report.location_lat) ||
            (location_long && parseFloat(location_long) !== report.location_long) ||
